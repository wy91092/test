...
{
private:
  std::vector<std::wstring> _word_vector;
  std::map<std::wstring, int> _word_map;
...
public:
  ...
  void find_similar_word(std::wstring &query);
  void find_top3_similar_word(std::wstring &query);
};
#endif
